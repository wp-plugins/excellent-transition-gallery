...
function etgwtlt_admin_option() 
{
    ...
    <hr />
    <a href='http://www.gopiplus.com/work/2010/07/18/excellent-transition-gallery/' target="_blank"><strong>All help & more Information available in this link.</strong></a><br /><br />
    ...
    <h2>3.Use below code in post or page</h2>
    ...
    <br />In above short code "sample.xml" is your gallery XML file, the XML file should be available in the gallery folder
    ...
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/excellent-transition-gallery/'><h2>Live demo</h2></a>
    Check this like for <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/excellent-transition-gallery/'>Live demo</a>
    <br></p>
	<?php
	echo "</div>";
}
