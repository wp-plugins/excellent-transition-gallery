...
Plugin URI: http://gopi.coolpage.biz/demo/2009/10/12/excellent-transition-gallery-with-title-link-target/
...
Donate link: http://gopi.coolpage.biz/demo/2009/10/12/excellent-transition-gallery-with-title-link-target/
*/
...
function etgwtlt_admin_option() 
{
	...
	<td width="31%" align="center" valign="middle"> <?php if (function_exists (gads)) gads(); ?> <br />
	   see below help to remove this ad. </td></tr></table>
	</form>
    <hr />
    <a href='http://gopi.coolpage.biz/demo/2009/10/12/excellent-transition-gallery-with-title-link-target/' target="_blank"><strong>All help & more Information available in this link and see demo in IE broswer.</strong></a><br /><br />
    ...
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/10/12/excellent-transition-gallery-with-title-link-target/'>click here</a> To post suggestion or comments or how to improve this plugin. <br> 
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/10/12/excellent-transition-gallery-with-title-link-target/'>click here</a> To see LIVE demo. <br> 
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/10/12/excellent-transition-gallery-with-title-link-target/'>click here</a> To download my other plugins.  
    ...
    2. excellent-transition-gallery.php go to line 76 and remove "include_once("extra.php");". <br />
    ...
    More doubt?<br>
	<a target="_blank" href='http://gopi.coolpage.biz/demo/2009/10/12/excellent-transition-gallery-with-title-link-target/'>View Answer</a>

    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/10/12/excellent-transition-gallery-with-title-link-target/'><h2><?php echo wp_specialchars( 'Live demo' ); ?></h2></a>
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/10/12/excellent-transition-gallery-with-title-link-target/'>Live demo</a>
    <br></p>
	<?php
	echo "</div>";
}
